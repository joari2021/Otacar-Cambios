...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post wallets_url, params: { wallet: { country: @wallet.country, email: @wallet.email, last_name: @wallet.last_name, name: @wallet.name } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { country: @wallet.country, email: @wallet.email, last_name: @wallet.last_name, name: @wallet.name } }
